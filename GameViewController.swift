...
//  FindNumber
//
//  Created by Катерина on 10.12.2021.
//
...
class GameViewController: UIViewController {
    ...
    private func showAlertActionSheet(){
        ...
        let showRecord = UIAlertAction(title: "Посмотреть рекодр", style: .default) { [weak self] (_) in
            
            self?.performSegue(withIdentifier: "recordVC", sender: nil)
        }
        
        let menuAction = UIAlertAction(title: "Перейти вменю", style: .destructive) { [weak self] (_) in
